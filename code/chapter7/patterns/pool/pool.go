...
// Pool manages as set of resources that can be shared safely by
...
// ErrPoolClosed is returned when an Acruire return on a
// closed pool.
...
func (p *Pool) Release(r io.Closer) {
	...
	select {
	// Atmpt to place the new resource on the queue.
	case p.resources <- r:
